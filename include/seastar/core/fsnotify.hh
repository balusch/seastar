...
///       are not backward compatible can be taken before finally freezing it.
///       Beside, the impl currently does not (yet) handle re-writing watches.
class fsnotifier {
    class impl;
...
public:
    ...
    public:
        ...
        ///
        /// \note Note that this operation won't unregistered the watch point,
        ///       but simply releases resource used internally.
        watch_token release();
    ...
    ///         inotify_add_wath(2) call completes.
    ...
    /// Shutdown notifier and abort any waiting event.
    ///
